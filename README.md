...
n summer 2023, the smoke from wildfires in Canada raised concerns about the Air Quality Index (AQI) in one's area.
...
if(aqi >= 1 && aqi <=50){
  ...
  console.log("Nosog'lom (sezgir guruhlar)")
}else if(aqi >= 151 && aqi <=200){
  console.log("Nosog'lom")
}else if(aqi >= 201 && aqi <=300){
  console.log("Juda nosog'lom")
}
else{
  console.log("Xafli")
}
